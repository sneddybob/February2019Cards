    ...
    public class Deck
    {
        ...
        public void FiveDraw() {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if(hand1Elem[i]-1 == hand1Elem[i + 1])
                {
                    h1Straight++;
                }
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if(hand2Elem[i]-1 == hand2Elem[i +1])
                {
                    h2Straight++;
                }
            }
            ...
            int oppHandVal = 0;
            //for straight flush
            if (hand1Suits.Count == 1 && h1Straight == 4)
            {
            ...
            // for fullhouse
            else if (hand1Suits.Count == 4 && hand1Values.Count == 2 && h1Counter == 2)
            {
            ...
            //for three of a kind
            else if (hand1Values.Count == 3 && h1Counter == 3)
            {
            ...
            //for two pair
            else if (hand1Values.Count == 3 && h1Counter == 1)
            {
            ...
            else if (h1Counter == 1)
            {
                for (int i = 0; i < 4 ; i++)
                {
                    if (hand1Elem[i] == hand1Elem[i + 1])
                    {
                        yourHandVal = 300+ hand1Elem[i];
                    }
                }
            }
            else
            {
                yourHandVal = hand1Elem[0];
            }

            if (hand2Suits.Count == 1 && h2Straight == 4)
            {
            ...
            // for fullhouse
            if (hand2Suits.Count == 4 && hand2Values.Count == 2 && h2Counter == 2)
            {
            ...
            if (hand2Values.Count == 3 && h2Counter == 1)
            {
            ...
            if (h2Counter == 1)
            {
                for (int i = 0; i < 4; i++)
                {
                    if (hand2Elem[i] == hand2Elem[i + 1])
                    {
                        oppHandVal = 300 + hand2Elem[i];
                    }
                }
            }
            else
            {
                oppHandVal = hand2Elem[0];
            }
